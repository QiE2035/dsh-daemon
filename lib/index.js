...
if (typeof module !== 'undefined' && module.exports) {
  if (String(process.env.DSH_DAEMON_TEST_HOOK) === '1') {
    ...
    plugin.__test = { DSH_NO_OPEN_MIN, DSH_TOKEN_AUTH_MIN, parseSemver, preGt, versionGte, dshNoOpenSupported, dshTokenAuthSupported, extractTokenUrl, parseShimTarget };
  }
