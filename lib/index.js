  ...
  if (sandboxHarness) {
    ...
    function watchdogScript(cfg, p, opts) {
      ...
      return '\'use strict\';\n' +
        ...
        '    const ps = \'Start-Process -FilePath \' + psq(process.execPath) + \' -ArgumentList \' + psArgs + \' -WindowStyle Hidden -RedirectStandardOutput \' + psq(WEB_LOG) + \' -PassThru | % { $_.Id } | Out-File -Encoding ascii \' + psq(WEB_PID);\n' +
...
if (typeof module !== 'undefined' && module.exports) {
  if (String(process.env.DSH_DAEMON_TEST_HOOK) === '1') {
    ...
    plugin.__test = { DSH_NO_OPEN_MIN, parseSemver, preGt, versionGte, dshNoOpenSupported };
  }
